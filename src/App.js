...
//         setTenzies(true);
//         console.log(timeTaken, score);
//         if (timeTaken < score) {
//             setScore(Math.round(timeTaken));
//         } else if (score === 0) {
//             setScore(Math.round(timeTaken));
//         } else if (timeTaken > score) {
//             console.log("some");
//         }
//         }
//     }, [dice,timeTaken]);
...
export default function App() {
    ...
    const [timeTaken, setTimeTaken] = React.useState(0);
    const [startTime, setStartTime] = React.useState(0);
    const [score, setScore] = React.useState(localStorage.getItem('score')?JSON.parse(localStorage.getItem('score')): 0);
    // console.log(score)
    React.useEffect(() => {
        const allDiceHeld = dice.every((die) => die.isHeld);
        const firstValue = dice[0].value;
